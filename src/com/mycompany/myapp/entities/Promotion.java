...
public class Promotion {
    ...
    public Promotion(String descriptionpromotion, Date start_date_promotion, Date end_date_promotion, float pourcentage) {
        this.descriptionpromotion = descriptionpromotion;
        this.start_date_promotion = start_date_promotion;
        this.end_date_promotion = end_date_promotion;
        this.pourcentage = pourcentage;
    ...
    public Promotion(int id, String descriptionpromotion, Date start_date_promotion, Date end_date_promotion, float pourcentage) {
        this.id = id;
        this.descriptionpromotion = descriptionpromotion;
        this.start_date_promotion = start_date_promotion;
        this.end_date_promotion = end_date_promotion;
