...
public class EditPub extends Form{
   ...
   String Imagecode;
    ...
    public EditPub(Form previous,Publicity v) {
        setTitle("Modifier Pub");
       ...
       try {  
            ...
            ByteArrayOutputStream out = new ByteArrayOutputStream();
                    try {
                        ...
                        Imagecode = Base64.encode(ba);
                           Publicity t = new Publicity(v.getId(),datePicker.getDate(),datePickerr.getDate(),tfdesc.getText(), filePath,tftitre.getText(),combo.getSelectedItem(),tflink.getText());

                           if( ServicePublicity.getInstance().editPub(t)){
                               {
        ...
        getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> new ListPub().show());
